    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 right-10 bottom-0">
                <a href={`#slide${prev}`} className="btn btn-circle hover:bg-orange-600 border-0 mr-5">❮</a>
                <a href={`#slide${next}`} className="btn btn-circle hover:bg-orange-600 border-0">❯</a>
            </div>
        </div>
    );
};
